...
sample conda.yaml using a development build from this location
...
dependencies:
  ...
  - pip:
      ...
      - https://github.com/mikahanninen/robots/blob/main/builds/rpaframework-15.0.0.929ce826ac2f-py3-none-any.whl?raw=true
```
